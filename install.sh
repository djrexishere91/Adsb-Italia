...
- MLAT client
- ADSBItalia dedicated feeder instance
...
collect_user_data() {
    FEEDER_NAME=$(whiptail --inputbox "Enter your feeder name:" 10 60 --title "Feeder Configuration" 3>&1 1>&2 2>&3) || exit 1
    LAT=$(whiptail --inputbox "Enter your latitude:" 10 60 --title "Coordinates" 3>&1 1>&2 2>&3) || exit 1
    LON=$(whiptail --inputbox "Enter your longitude:" 10 60 --title "Coordinates" 3>&1 1>&2 2>&3) || exit 1
...
show_status() {
    ...
    whiptail \
        ...
        --msgbox "ADSBItalia feeder installation completed successfully.
